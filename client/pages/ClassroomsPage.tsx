...
export const ClassroomsPage: React.FC = () => {
  ...
  const userRole = currentUser
    ? localStorage.getItem(`user_${currentUser.uid}_role`)
    : null;
      ...
      if (isTeacher) {
        ...
        for (const classroom of classroomsData) {
          try {
            ...
            console.error(
              `Error loading stats for classroom ${classroom.id}:`,
              error,
            );
          ...
          {filteredClassrooms.length === 0 ? (
            <div className="text-center py-16">
              ...
              {!searchTerm && (
                <button
                  onClick={() =>
                    isTeacher ? setShowCreator(true) : setShowJoin(true)
                  }
                  ...
                  <>
                    <div className="text-center">
                      <p className="text-2xl font-bold text-green-400">
                        {Object.values(classroomStats).reduce(
                          (sum, stats) => sum + stats.totalStudents,
                          0,
                        )}
                      </p>
                    ...
                    <div className="text-center">
                      <p className="text-2xl font-bold text-purple-400">
                        {Object.values(classroomStats).reduce(
                          (sum, stats) => sum + stats.totalAssignments,
                          0,
                        )}
                      </p>
