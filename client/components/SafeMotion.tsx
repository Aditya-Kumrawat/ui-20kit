...
export const SafeMotionDiv = React.forwardRef<HTMLDivElement, MotionProps>((props, ref) => {
...
export const SafeMotionCircle = React.forwardRef<SVGCircleElement, MotionProps & React.SVGProps<SVGCircleElement>>((props, ref) => {
  const safeProps = { ...props };
...
export const SafeMotionRect = React.forwardRef<SVGRectElement, MotionProps & React.SVGProps<SVGRectElement>>((props, ref) => {
  const safeProps = { ...props };
